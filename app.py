...
with col2:
    ...
    fig2 = px.line(trend_df, x='year', y='Access to electricity (% of population)', 
                   color_discrete_sequence=['darkorange'], height=250)
...
with col3:
    fig3 = px.scatter(filtered_df, x="GDP per capita (current US$)", y="Access to electricity (% of population)",
                      log_x=True, color_discrete_sequence=['steelblue'], height=250)
...
with col4:
    ...
    fig4 = px.bar(x=counts.index, y=counts.values, color_discrete_sequence=['#9ECAE1'], height=250)
